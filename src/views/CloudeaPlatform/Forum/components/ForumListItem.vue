  ...
  <div class="entry">
    <div class="content-wrap">
      <div class="content-main">
        <div class="title-row">
          <a class="title" href="">{{ props.data.title }}</a>
        </div>
        <div class="abstract">
          <a href="">
            <div>
        ...
        <div class="entry-footer">
          <ul class="action-list">
            <li class="item meta-container">
              <a class="user-info" href="">
                <div class="user-popover">{{ props.data.author.userName }}</div>
              </a>
          ...
          <div class="entry-footer-tags">
            <a href="" class="footer-tag footer-tag-only width-limited">Linux</a>
          </div>
        </div>
      </div>
...
<style scoped>
  ...
  .action-list > .item.like:hover span {
    color: var(--Cloudea-Font-Hover-Blue);
  }

  .action-list > .item.like:hover .liked-icon path {
    fill: var(--Cloudea-Font-Hover-Blue);
  }
