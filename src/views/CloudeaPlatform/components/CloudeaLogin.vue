...
<template>
  <div class="bili-mini-mask">
    <div class="bili-mini-content-wp">
      <div class="bili-mini-close-icon" style="`background${getImageUrl('./close.svg')}``"></div>
      <div class="bili-mini-login-right-wp">
        ...
        <div class="login-pwd-wp" v-if="loginType">
          ...
          <div data-v-327e145a="" class="btn_wp">
            <div data-v-327e145a="" class="btn_other">注册</div>
            <div data-v-327e145a="" class="btn_primary disabled">登录</div>
          </div>
        </div>
        <!-- 邮箱登录 -->
...
<style scoped>
  ...
  .bili-mini-content-wp a,
  .bili-mini-content-wp i,
  .bili-mini-content-wp input,
  .bili-mini-content-wp li,
  .bili-mini-content-wp ol,
  .bili-mini-content-wp p,
  .bili-mini-content-wp ul {
    margin: 0;
    padding: 0;
    border: 0;
    font-weight: 400;
